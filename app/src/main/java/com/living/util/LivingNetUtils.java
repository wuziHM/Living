...
public class LivingNetUtils {
    ...
    private static final String URL_WEATHER = "http://apis.baidu.com/heweather/weather/free?city=beijing";
    ...
    public static void getWeather(Response.Listener<CountryWeatherBean> listener, Response.ErrorListener errorListener, TreeMap<String, String> map) {
        LivingRequest<CountryWeatherBean> request = new LivingRequest<>(Request.Method.GET,
                URL_WEATHER,CountryWeatherBean.class,listener,errorListener,map);
        Map<String, String> header = new HashMap<>();
